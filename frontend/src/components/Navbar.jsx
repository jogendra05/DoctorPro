...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between border-b border-b-gray-400  text-sm py-4'>
        ...
        <div className='items-center gap-4'>
            {
                ...
                :<button onClick={() => navigate('/login')} className='bg-[#5f6fff] px-8 py-3 rounded-full text-white font-light hidden md:block flex'>Create Account</button>
            }
